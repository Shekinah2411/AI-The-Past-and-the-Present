...
from LLM import get_llm_response, reset_llm_conversation
...
class ChatComparisonGUI:
    SAMPLE_PROMPTS = [
        "Hello",
        "My name is Sam",
        "I feel stressed about my assignment",
        "I need help with school",
        "I can't focus because I am worried",
    ]
    ...
    def build_ui(self):
        ...
        prompt_label = tk.Label(
            bottom_frame,
            text="Suggested comparison prompts:",
            font=("Segoe UI", 10),
            fg="#cbd5e1",
            bg="#0f172a",
        )
        ...
        prompt_frame = tk.Frame(bottom_frame, bg="#0f172a")
        ...
        for prompt in self.SAMPLE_PROMPTS:
            prompt_btn = tk.Button(
                ...
                padx=12,
                pady=6,
                command=lambda value=prompt: self.use_prompt(value)
            )
            prompt_btn.pack(side="left", padx=(0, 8))
    ...
    def use_prompt(self, prompt_text):
        ...
        self.input_box.insert(0, prompt_text)
        self.send_message()
